    ...
    return this.each(function() {
      ...
      function _initSettings() {
        ...
        settings = $.extend({
          ...
          sliders: true,
          grouping: true,
          swatches: ['000000', 'FFFFFF', 'FFBB18', 'C3CBE1', '8F8F8F', 'D30C0E', '0056B8', '53A2E5', 'AEDDD0', 'E41C24', 'F995EB', 'F1ED7C', '5DFB80', 'FF2B02', 'C0C0C0', '808080', 'FF0000', '800000', 'FFFF00', '808000', '00FF00', '008000', '00FFFF', '008080', '0000FF', '000080', 'FF00FF', '800080', 'EEEBE6', 'CBE3E5', '8D7A69'], // array or false to disable swatches
      ...
      function _getControllerHtml() {
        ...
        if (settings.grouping) {
          ...
          if (settings.sliders && sliders.length > 0) {
            color_picker_html += '<li><a href="#" class="cp-pill-sliders">RGB選色器</a></li>';
          }
          if (settings.swatches) {
            color_picker_html += '<li><a href="#" class="cp-pill-swatches">色票</a></li>';
          }
